...
?>
                ...
                <form action="saveDepositos" method="POST" id="f_deposito_sp">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="mb-2">
                                <label for="fecha_mov_bitcoin" class="form-label">Fecha de Depósito</label>
                                <input type="date" class="form-control" id="fecha_mov_bitcoin" name="fecha_mov_bitcoin" required>
                            </div>
                               <div class="mb-2">
 ...
 $(document).ready(function() {
    $('#fecha_mov_bitcoin').on('change', function() {
        var fecha = $(this).val();
        if (fecha) {
        ...
        try {
            ...
            if (response.p_mercado !== null) {
                ...
                if (!isNaN(montoInversionOriginal) && montoInversionOriginal > 0) {
                    ...
                    var montoInversionConComision = (montoInversionOriginal * 0.98).toFixed(2);
