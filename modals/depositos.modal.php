            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-xl-4 row-cols-xxl-3">
              <div class="col">
                <div class="card radius-10">
                  ...
                  <form action="depositosEvent" method="POST" >
                                    <input type="hidden" name="fk_cliente" value="<?=$Cliente['id_cliente']?>"  >
                                    <input type="hidden" name="fk_fondo" value="1"  >
                                   
                                    <input type="hidden" name="status_rel" value="1"  >
              ...
              <div class="col">
                ...
                <div class="card radius-10">
                  <div class="card-body">
                    ...
                    <h5 class="mb-0" tittle = "Saldo Total" > $<?=number_format($tiee[0]['total_tiie'],2)?> </h5>
                                        ...
                                        <form action="depositostiie" method="POST" >
                                    <input type="hidden" name="fk_cliente" value="<?=$Cliente['id_cliente']?>"  >
                                    <input type="hidden" name="fk_fondo" value=""  >
                  ...
                  <div class="card-body">
                    ...
                    <h5 class="mb-0" tittle = "Saldo Total" > $<?=number_format($saldoTotalGarant,2)?> </h5>
                                    <h5 class="mb-0 float-end " title="Numero de Contrato"  ><?=$garant[0]['num_contrato']?></h5>
                                      ...
                                      <form action="">
                  <a class="btn btn-sm btn-outline-primary float-end" >Agregar</a>
                  </form>
                </div>
               ...
               <div class="col">
                <div class="card radius-10">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="widget-icon-2 bg-dark text-light ">
                      <i class="lni lni-sketch"></i>
                      </div>
                         </div>
                    <h5 class="my-3">S&P</h5>
                    
                    <h4 class="mb-0" tittle = "Saldo Total" > $<?=number_format($sp[0]['saldo_total'],2)?> </h4>
                                <h5 class="mb-0 float-end " title="Numero de Contrato"  ><?=$sp[0]['num_contrato']?></h5>
                                  </div>
                                  <form action="depositoSp" method="POST" >
                                    <input type="hidden" name="fk_cliente" value="<?=$Cliente['id_cliente']?>"  >
                                    <input type="hidden" name="fk_fondo" value="8"  >
                                    <input type="hidden" name="fk_serie" value="1"  >
                                    <input type="hidden" name="status_rel" value="1"  >
                  <button class="btn btn-sm btn-outline-primary float-end" >Agregar</button>
                  </form> 
                </div>
               ...
               <div class="col">
                <div class="card radius-10">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="widget-icon-2 bg-warning text-light ">
                      <i class="lni lni-bitcoin"></i>
                      </div>
                         </div>
                    <h5 class="my-3">Bitcoin Mxn</h5>
                    
                    <h4 class="mb-0" tittle = "Saldo Total" > <?=number_format($bitcoin[0]['saldo_total'],6)?> </h4>
                                <h5 class="mb-0 float-end " title="Numero de Contrato"  ><?=$bitcoin[0]['num_contrato']?></h5>
                                  </div>
                                  <form action="depositoBitcoin" method="POST" >
                                    <input type="hidden" name="fk_cliente" value="<?=$Cliente['id_cliente']?>"  >
                                    <input type="hidden" name="fk_fondo" value="9"  >
                                    <input type="hidden" name="fk_serie" value="1"  >
                                    <input type="hidden" name="status_rel" value="1"  >
                  <button class="btn btn-sm btn-outline-primary float-end" >Agregar</button>
                  </form> 
               ...
               <div class="col">
                <div class="card radius-10">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="widget-icon-2 bg-gradient-success text-light ">
                      <i class="lni lni-bitcoin"></i>
                      </div>
                         </div>
                    <h5 class="my-3">Bitcoin Usd</h5>
                    
                    <h4 class="mb-0" tittle = "Saldo Total" > <?=number_format($bitcoin[0]['saldo_total'],6)?> </h4>
                                <h5 class="mb-0 float-end " title="Numero de Contrato"  ><?=$bitcoin[0]['num_contrato']?></h5>
                                  </div>
                                  <form action="depositoBitcoinUsd" method="POST" >
                                    <input type="hidden" name="fk_cliente" value="<?=$Cliente['id_cliente']?>"  >
                                    <input type="hidden" name="fk_fondo" value="9"  >
                                    <input type="hidden" name="fk_serie" value="1"  >
                                    <input type="hidden" name="status_rel" value="1"  >
